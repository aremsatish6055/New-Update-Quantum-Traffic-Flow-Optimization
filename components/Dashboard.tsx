...
import { XIcon, LoadingSpinner } from './icons/Icons';
        ...
        >
            ...
            >
                ...
                <div className="p-4 bg-black">
                    <div
                        className="w-full aspect-[16/9] relative overflow-hidden rounded-md bg-gray-900"
                    ...
                    >
                        <AnimatePresence>
                            {isImageLoading && (
                                ...
                                >
                                    <LoadingSpinner />
                                    <span className="ml-3 text-gray-300">Loading Feed...</span>
                                </motion.div>
                            )}
                        </AnimatePresence>
                        ...
                        />
                        <div className="absolute top-2 left-2 bg-red-600/80 text-white text-xs font-mono px-2 py-0.5 rounded flex items-center gap-1 pointer-events-none">
                            <div className="w-2 h-2 rounded-full bg-red-400 animate-pulse"></div>
                            <span>REC</span>
                        </div>
                        <div className="absolute bottom-2 right-2 text-white/50 text-xs font-mono pointer-events-none">
